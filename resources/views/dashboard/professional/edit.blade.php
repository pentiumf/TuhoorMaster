...
@section('content')
	...
	{!! Form::model($profile, ['method' => 'PATCH', 'action' => ['UserProfessionalController@update', $profile->id],  'files' => true]) !!}
    ...
    <div class="form-group">
		...
		{!! Form::submit('Update Profile', ['class' => 'btn btn-primary', 'rows'=>3]) !!}
	...
	<div class="delete">
	    ...
	    {!! Form::open(['method' => 'DELETE', 'action' => ['UserProfessionalController@destroy', $profile->id]]) !!}
